...
\author{
        Author: Duc Dinh Anh 
        \\[1\baselineskip]Email:    ducda.m20ict@st.usth.edu.vn
        \\[1\baselineskip]Mobile:   (+84) 982 086 651}
...
\\
\underline{\emph{Strategy}}\\[1\baselineskip]
...
- R: \textbf{Recovered}, meaning that the individual has recovered from disease and cannot be infected anymore.\\[1\baselineskip]
...
\\[1\baselineskip]
\underline{\emph{Requirement}}\\[1\baselineskip]
...
\includegraphics[width=0.70\textwidth]{complex_project_1}
\\
...
\includegraphics[width=0.70\textwidth]{complex_project_2}
\\
...
\\[1\baselineskip]
\centering{\begin{pic12}}
\includegraphics[width=0.68\textwidth]{complex_project_12}
\\
\caption{Figure 12: Exploration M2\_1, 2, purple inhabitants are moving.} 
\end{pic12}
\\
\centering{\begin{pic13}}
\includegraphics[width=0.68\textwidth]{complex_project_13}
\\
\caption{Figure 13: Exploration M2\_1, 2, all inhabitants with the susceptible state become exposed inhabitants, after that they will become infected inhabitant (From 3 to 10 days).} 
\end{pic13}
\\[1\baselineskip]
\centering{\begin{pic14}}
\includegraphics[width=0.68\textwidth]{complex_project_14}
\\
\caption{Figure 14: Exploration M2\_1, 2, all exposed inhabitants become infected inhabitants.} 
\end{pic14}
\\
\centering{\begin{pic15}}
...
\end{pic18}
\newpage
\raggedright\underline{\textbf{#Model M2\_4}}
\\[1\baselineskip]
\underline{\emph{Requirement}}
\\[1\baselineskip]
...
\end{pic22}
\newpage
\raggedright\section{Public health policy}
...
\newpage
\centering{\begin{pic23}}
\includegraphics[width=1.15\textwidth]{complex_project_23}
\\
\caption{Figure 23: Exploration M3\_1, all inhabitants get freedom law.} 
\end{pic23}
\\[2\baselineskip]
\centering{\begin{pic24}}
\includegraphics[width=1.15\textwidth]{complex_project_24}
\\
\caption{Figure 24: Exploration M3\_1, all inhabitants get lockschool law when it finds out the infected case.} 
\end{pic24}
\\[1\baselineskip]
\centering{\begin{pic25}}
\includegraphics[width=1.15\textwidth]{complex_project_25}
\\
...
\end{pic25}
\\[2\baselineskip]
\centering{\begin{pic26}}
\includegraphics[width=1.15\textwidth]{complex_project_26}
\\
